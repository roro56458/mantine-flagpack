  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-o7bspp3mj" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-d6f74pg83" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-94q7eodni" />
          </mask>
          <mask id="mantine-0hmbqub3s" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-pca0wh1y8" />
          </mask>
          <path id="mantine-94q7eodni" d="M0 0h32v24H0z" />
          <path id="mantine-pca0wh1y8" d="M0 0v24l18-12z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-o7bspp3mj)">
          <use fill="#bf2714" xlinkHref="#mantine-94q7eodni" />
          <path fill="#3d58db" d="M0-2h32v14H0z" mask="url(#mantine-d6f74pg83)" />
          <use fill="#f7fcff" xlinkHref="#mantine-pca0wh1y8" />
          <g fill="#feca00">
            <path
