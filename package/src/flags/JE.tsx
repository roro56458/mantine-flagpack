...
export function JEFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <filter id="mantine-sj6cefjve" width="100%" height="100%" x="0%" y="0%">
          ...
          />
          <mask id="mantine-owb8b4zgd" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-owb8b4zgd)">
          <g fill="#f7fcff">
          ...
          <g transform="translate(12.8 2)">
            ...
            />
            <use fill="#000" filter="url(#mantine-sj6cefjve)" xlinkHref="#mantine-z03lmjq2o" />
            <use fill="#feca00" xlinkHref="#mantine-z03lmjq2o" />
          </g>
        </g>
      </svg>
    </Box>
