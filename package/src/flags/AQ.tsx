...
export function AQFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-9tk7d10ql" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-0axri3xsa" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-tyhju26k8" />
          </mask>
          <path id="mantine-tyhju26k8" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-9tk7d10ql)">
          <use fill="#5196ed" xlinkHref="#mantine-tyhju26k8" />
          <g fill="#f5f8fb" mask="url(#mantine-0axri3xsa)">
