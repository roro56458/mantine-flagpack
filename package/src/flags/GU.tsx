...
export function GUFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <mask id="mantine-jrotjtypp" fill="#fff">
          <path fillRule="evenodd" d="M0 0h32v24H0z" />
        </mask>
        <mask id="mantine-shgacr2ug" fill="#fff">
          <path fillRule="evenodd" d="M4 4h24v16H4z" />
        </mask>
        <mask id="mantine-xbjum44dv" fill="#fff">
          <path
            fillRule="evenodd"
            d="M4 .037C6.667 1.47 8 3.38 8 5.767s-1.333 4.438-4 6.15c-2.667-1.78-4-3.83-4-6.15 0-2.32 1.333-4.23 4-5.73z"
          />
        </mask>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-jrotjtypp)">
