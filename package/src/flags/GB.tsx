    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 24">
        ...
        <g mask="url(#mantine-rzh9qsks4)">
          ...
          <g mask="url(#mantine-i3qvkvdoi)">
            <mask
              id="mantine-0fxlqs6gf"
              style={{ maskType: 'alpha' }}
              width="32"
              height="24"
              x="0"
            ...
            <g mask="url(#mantine-0fxlqs6gf)">
              ...
              />
              <mask id="mantine-ibqicuf6f" fill="#fff">
                <path
                  fillRule="evenodd"
