...
export function OMFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-vjxsn0fzv" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-thkyqhvax" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-rsx9xodym" />
          </mask>
          <path id="mantine-rsx9xodym" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-vjxsn0fzv)">
          <use fill="#f50101" xlinkHref="#mantine-rsx9xodym" />
          <path fill="#f7fcff" d="M0 0h32v8H0z" mask="url(#mantine-thkyqhvax)" />
          <path fill="#5eaa22" d="M0 16h32v8H0z" mask="url(#mantine-thkyqhvax)" />
          <path fill="#f50101" d="M0 0h12v24H0z" mask="url(#mantine-thkyqhvax)" />
          <g fill="#f7fcff" mask="url(#mantine-thkyqhvax)">
