  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-sb6wa89rs" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-0v7ktw55g" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-roohco0yz" />
          </mask>
          <path id="mantine-roohco0yz" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-sb6wa89rs)">
          <use fill="#e31d1c" xlinkHref="#mantine-roohco0yz" />
          <path
            fill="#f7fcff"
