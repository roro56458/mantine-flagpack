...
export function ESFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
        ...
        <g mask="url(#mantine-iniwnlve2)">
          ...
          <g mask="url(#mantine-heefuce8q)">
            ...
            <path
              fill="#C88A02"
              fillRule="evenodd"
              d="M6.576 9.264H4.56v.56h.336v.448H6.24v-.448h.336v-.56zm-.336 7.168h.336v.56H4.56v-.56h.336v-.448H6.24v.448z"
              clipRule="evenodd"
            />
            <path
              fill="#AD1619"
              fillRule="evenodd"
              d="M5.568 9.376c.244 0 .269-.092.412-.229.112-.106.372-.238.372-.387 0-.34-.351-.616-.784-.616-.433 0-.784.276-.784.616 0 .166.18.276.315.387.142.117.247.229.47.229z"
              clipRule="evenodd"
            />
            <path
              fill="#005BBF"
            ...
            <g fill="#fff" mask="url(#mantine-pcr11w7rc)">
            ...
            <path
              fill="#C88A02"
              fillRule="evenodd"
              d="M17.552 9.264h-2.016v.56h.336v.448h1.344v-.448h.336v-.56zm-.336 7.168h.336v.56h-2.016v-.56h.336v-.448h1.344v.448z"
              clipRule="evenodd"
            />
            <path
              fill="#AD1619"
              fillRule="evenodd"
              d="M16.544 9.376c.244 0 .268-.092.412-.229.112-.106.372-.238.372-.387 0-.34-.351-.616-.784-.616-.433 0-.784.276-.784.616 0 .166.18.276.315.387.142.117.247.229.469.229z"
              clipRule="evenodd"
            />
            <path
              fill="#005BBF"
            ...
            <path
              fill="#C88A02"
              d="M10.13 5.439c-.513 0-.723.124-.843.493-.077.234-.003.435.238.622l-.137.177c-.312-.242-.422-.539-.314-.869.153-.47.453-.647 1.055-.647.395 0 .702.103.916.314l.034.033v1.08h-.224v-.984c-.167-.145-.408-.22-.726-.22z"
            />
            <path
              fill="#fff"
              d="M13.05 5.7l.001.112c.993-.018 1.563.127 1.707.416.15.299.122.662-.087 1.093l.1.05c.224-.461.254-.86.088-1.193-.172-.343-.775-.496-1.81-.478z"
            />
            <path
              fill="#fff"
              d="M12.698 6.604l.058.096c.216-.129.324-.35.324-.653 0-.436-.225-.692-.722-.867-.317-.112-.75-.066-1.302.133l.038.106c.53-.192.939-.235 1.227-.134.456.16.647.379.647.762 0 .267-.09.45-.27.557z"
            />
            <path
              fill="#C88A02"
              d="M14.6 7.15l.21.074c.22-.625.157-1.049-.217-1.232-.33-.16-.812-.226-1.446-.2l.009.223c.6-.024 1.048.037 1.338.179.247.12.292.425.105.955z"
            />
            <path
              fill="#C88A02"
              d="M12.117 5.456c.513 0 .723.125.843.493.077.235.002.435-.239.622l.138.177c.312-.242.422-.539.314-.868-.153-.47-.454-.648-1.056-.648-.394 0-.702.104-.916.315l-.033.033v1.08h.224v-.985c.167-.145.407-.219.725-.219z"
            />
            <path
              fill="#E1E5E8"
              fillRule="evenodd"
              d="M7.472 9.264h7.28v6.54S14.212 18 11.112 18s-3.64-2.253-3.64-2.253V9.264z"
              clipRule="evenodd"
              opacity=".3"
            />
            <mask
              id="mantine-qf4nhsvr4"
              style={{ maskType: 'alpha' }}
              width="8"
              height="9"
              x="7"
            ...
            <g mask="url(#mantine-qf4nhsvr4)">
              ...
              <path
                ...
                clipRule="evenodd"
              />
              <path fill="#C88A02" d="M12.979 9.795l.23-.245.48.45-.229.245-.481-.45z" />
              <path
                fill="#FFC034"
                fillRule="evenodd"
                d="M14.36 16.14v-2.452h-2.8v2.432l.005.018c.141.604.624.91 1.395.91.77 0 1.253-.298 1.395-.888l.005-.02zm-1.4.572c-.619 0-.957-.208-1.064-.632v-2.056h2.128v2.075c-.107.41-.445.613-1.064.613z"
                clipRule="evenodd"
              />
              <path
                fill="#FFC034"
                fillRule="evenodd"
                d="M13.076 13.893h-.234v1.112l-.92-1-.164.15.831.905h-.753v.336h.772l-.85.925.165.152.92-1v1.299h.233v-1.183l.812.884.165-.152-.85-.925h.949v-.336h-.931l.832-.904-.165-.152-.812.884v-.995z"
                clipRule="evenodd"
              />
              <path
                fill="#F1F9FF"
                fillRule="evenodd"
                d="M13.483 17.443s-2.372.186-2.372-1.344c0 0-.023 1.344-2.5 1.344v1.207h4.872v-1.207z"
                clipRule="evenodd"
              />
              <path
                fill="#005BBF"
                ...
                stroke="#AD1619"
                strokeWidth="1.167"
                d="M11.112 14.192c.464 0 .84-.401.84-.896s-.376-.896-.84-.896c-.464 0-.84.401-.84.896s.376.896.84.896z"
                clipRule="evenodd"
              />
            </g>
          </g>
