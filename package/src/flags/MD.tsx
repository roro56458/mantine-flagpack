  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-34x2py8va" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-us23d2hxt" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-nfgcwro7a" />
          </mask>
          <path
            id="mantine-nfgcwro7a"
            d="M0 0h10.56v7.639a31.49 31.49 0 00-5.28 2.137C4.004 8.83 2.244 8.117 0 7.64z"
          />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-34x2py8va)">
          ...
          <g transform="translate(11.04 7.833)">
            <use fill="#e1e5e8" opacity=".3" xlinkHref="#mantine-nfgcwro7a" />
            <path fill="#3d58db" d="M0 5h10.56v5H0z" mask="url(#mantine-us23d2hxt)" />
            <path fill="#fd1900" d="M0 0h10.56v5H0z" mask="url(#mantine-us23d2hxt)" />
            <g fill="#fdff00">
              <path
                d="M5.06 2.333l-.66.457.088-.77-.749-.312.749-.313-.089-.77.66.458.66-.458-.088.77.748.313-.748.312.088.77z"
                mask="url(#mantine-us23d2hxt)"
              ...
              <path
                ...
                mask="url(#mantine-us23d2hxt)"
              />
              <circle cx="1.88" cy="7.667" r="1" mask="url(#mantine-us23d2hxt)" />
              <path
