  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-32foe1ofp" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-wnd711tk3" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-6gnt9isdc" />
          </mask>
          <path id="mantine-6gnt9isdc" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-32foe1ofp)">
          <use fill="#f7fcff" xlinkHref="#mantine-6gnt9isdc" />
          <path fill="#e31d1c" d="M0 0h32v12H0z" mask="url(#mantine-wnd711tk3)" />
          <path
            fill="#f1f9ff"
