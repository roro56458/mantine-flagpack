...
export function SKFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-3cu2malx3" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-nsojthfp7" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-c99gsq7ix" />
          </mask>
          <mask id="mantine-68qu8bwp3" fill="#fff">
            <path
              fillRule="evenodd"
          ...
          <path id="mantine-c99gsq7ix" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-3cu2malx3)">
          <use fill="#3d58db" xlinkHref="#mantine-c99gsq7ix" />
          <path fill="#f7fcff" d="M0 0h32v8H0z" mask="url(#mantine-nsojthfp7)" />
          <path fill="#e31d1c" d="M0 16h32v8H0z" mask="url(#mantine-nsojthfp7)" />
          <g mask="url(#mantine-nsojthfp7)">
            <path
              stroke="#fff"
