  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-vfzjcg671" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-rfkem1vlr" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-z5l2v99wr" />
          </mask>
          <mask id="mantine-bfr3023x2" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-c7ikx9en0" />
          </mask>
          <path id="mantine-z5l2v99wr" d="M0 0h32v24H0z" />
          <path id="mantine-ujtzt10nu" d="M15.927 3.704l12.202 8.504L15.76 20.17 3.809 12.043z" />
          <linearGradient id="mantine-4kiz60rmf" x1="50%" x2="50%" y1="100%" y2="0%">
            <stop offset="0" stopColor="#ffc600" />
            <stop offset="1" stopColor="#ffde42" />
          </linearGradient>
          <filter id="mantine-n73tfxanv" width="76%" height="68.6%" x="11.9%" y="15.4%">
          ...
          <circle id="mantine-c7ikx9en0" cx="16" cy="12.2" r="5" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-vfzjcg671)">
          <use fill="#093" xlinkHref="#mantine-z5l2v99wr" />
          <g mask="url(#mantine-rfkem1vlr)">
            <use fill="#000" filter="url(#mantine-n73tfxanv)" xlinkHref="#mantine-ujtzt10nu" />
            <use fill="#ffd221" xlinkHref="#mantine-ujtzt10nu" />
            <use fill="url(#mantine-4kiz60rmf)" xlinkHref="#mantine-ujtzt10nu" />
            <use fill="#2e42a5" xlinkHref="#mantine-c7ikx9en0" />
            <g fill="#f7fcff">
              <path
