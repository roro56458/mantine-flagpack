...
export function MOFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-yr0vo3f9h" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-0cqe4263j" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-ggmrzic3h" />
          </mask>
          <mask id="mantine-qzuwunm9y" fill="#fff">
            <circle cx="8" cy="8" r="8" fillRule="evenodd" />
          </mask>
          <path id="mantine-ggmrzic3h" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-yr0vo3f9h)">
          <use fill="#1c9975" xlinkHref="#mantine-ggmrzic3h" />
          <g fill="#feca00" mask="url(#mantine-0cqe4263j)">
          ...
          <g fill="#f7fcff" mask="url(#mantine-0cqe4263j)">
            <path
              d="M4.68 15.064h6.64v1.072H4.68zM1.957 13.46h12.766v.983H1.957z"
              mask="url(#mantine-qzuwunm9y)"
