  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-lf1df5817" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-h9b0onoiv" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-4yj5soz27" />
          </mask>
          <mask id="mantine-z8d684dt3" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-eksmehaa1" />
          </mask>
          <path id="mantine-4yj5soz27" d="M0 0h32v24H0z" />
          <path id="mantine-eksmehaa1" d="M2.738.004L.002 4.735h5.516z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-lf1df5817)">
          <use fill="#f7fcff" xlinkHref="#mantine-4yj5soz27" />
          <path fill="#0080ec" d="M0 0h32v8H0zm0 16h32v8H0z" mask="url(#mantine-h9b0onoiv)" />
          <g mask="url(#mantine-h9b0onoiv)">
            <path
              fill="#d0ab00"
              fillRule="nonzero"
            ...
            <g transform="translate(13.236 8.945)">
              <use fill="#7cdfff" xlinkHref="#mantine-eksmehaa1" />
              <g mask="url(#mantine-z8d684dt3)">
