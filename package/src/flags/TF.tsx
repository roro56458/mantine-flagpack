  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-9hqzwrnp6" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-b0t5nauyx" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-31iuqzxcu" />
          </mask>
          <mask id="mantine-0cxiihm6u" fill="#fff">
            <path fillRule="evenodd" d="M0 0h12v10H0z" />
          </mask>
          <path id="mantine-31iuqzxcu" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-9hqzwrnp6)">
          <use fill="#2e42a5" xlinkHref="#mantine-31iuqzxcu" />
          <g fill="#f7fcff" mask="url(#mantine-b0t5nauyx)">
          ...
          <g mask="url(#mantine-b0t5nauyx)">
            <path stroke="#fff" d="M-.5-.5h13v11h-13z" />
            <path fill="#f50100" d="M8 0h4v10H8z" mask="url(#mantine-0cxiihm6u)" />
            <path fill="#2e42a5" d="M0 0h4v10H0z" mask="url(#mantine-0cxiihm6u)" />
            <path fill="#f7fcff" d="M4 0h4v10H4z" mask="url(#mantine-0cxiihm6u)" />
          </g>
        </g>
      </svg>
    </Box>
