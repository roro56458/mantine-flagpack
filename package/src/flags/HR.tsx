...
export function HRFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
        ...
        <g mask="url(#mantine-0thdf3eba)">
          ...
          <g mask="url(#mantine-x9gfcpyoi)">
            ...
            <path
              ...
              stroke="#fff"
              strokeWidth=".5"
              d="M10.453 8.163s.652-.349 1.209-.528c.556-.18.996-.278.996-.278l-.828-3.052-1.658-.62-.94 1.548 1.221 2.93z"
              clipRule="evenodd"
            />
            <path
              fill="#fff"
              d="M10.181 6.49l.19-.091c.197.42.457.55.812.418.364-.135.511-.392.46-.798l.208-.028c.065.505-.138.857-.595 1.027-.464.174-.834-.012-1.075-.527z"
            />
            <path
              fill="#FECA00"
              fillRule="evenodd"
              d="M10.632 5.542l-.182.11a.054.054 0 01-.081-.057l.041-.209-.186-.102a.054.054 0 01.008-.1l.202-.068-.005-.213a.054.054 0 01.09-.042l.16.14.183-.11c.04-.024.09.011.081.057l-.041.21.186.102a.054.054 0 01-.008.099l-.202.068.005.213a.054.054 0 01-.09.042l-.16-.14z"
              clipRule="evenodd"
            />
            <path
              fill="#56C6F5"
              ...
              stroke="#fff"
              strokeWidth=".5"
              d="M14.54 7.076s.557-.05 1.142-.038c.584.01 1.079.015 1.079.015l.286-3.01-1.253-1.13-1.392 1.157.139 3.006z"
              clipRule="evenodd"
            />
            <path
              fill="#FECA00"
              fillRule="evenodd"
              d="M15.75 6.585c.483 0 .529-.521.529-.876-.124-.197-.099-.338-.494-.338-.396 0-.44.12-.556.338 0 .355.039.876.521.876zm.543-1.472c.482 0 .529-.521.529-.876-.124-.197-.099-.338-.494-.338-.396 0-.44.12-.556.338 0 .355.039.876.521.876zm-1.055 0c.483 0 .529-.521.529-.876-.123-.197-.099-.338-.494-.338s-.44.12-.556.338c0 .355.039.876.521.876z"
              clipRule="evenodd"
            />
            <path
              fill="#2E42A5"
            ...
            <g mask="url(#mantine-zd5pqi5wr)">
              <path
                fill="#FECA00"
                fillRule="evenodd"
                d="M21.127 5.09l-.142.158a.054.054 0 01-.094-.03l-.021-.213-.209-.043a.054.054 0 01-.02-.097l.172-.125-.066-.202a.054.054 0 01.073-.067l.195.088.142-.159a.054.054 0 01.094.03l.021.213.209.043c.046.01.059.07.02.097l-.172.125.066.202a.054.054 0 01-.073.066l-.195-.087z"
                clipRule="evenodd"
              />
              <path
                fill="#E31D1C"
                d="M18.995 6.488l.212-.83c.941.249 1.922.567 2.641.875l-.327.79c-.68-.291-1.623-.597-2.526-.835z"
              />
              <path
                fill="#fff"
                d="M19.283 5.722l.05-.208c.902.224 1.86.58 2.557.913l-.09.194a14.127 14.127 0 00-2.517-.899zm-.267.855l.05-.209a13.04 13.04 0 012.432.86l-.09.194a12.767 12.767 0 00-2.392-.845z"
              />
              <path
                fill="#272727"
                d="M19.423 6.175l.193-.087c.081.19.182.232.35.15.396-.192 1.38.077 1.38.44 0 .142-.082.228-.208.223a.66.66 0 01-.257-.086 4.297 4.297 0 01-.044-.022 1.315 1.315 0 00-.164-.079l.07-.205c.045.017.052.02.188.09l.042.02a.543.543 0 00.173.065c.003 0-.011.015-.011-.006 0-.16-.8-.379-1.08-.243-.277.134-.504.04-.632-.26z"
              />
            </g>
          </g>
        </g>
