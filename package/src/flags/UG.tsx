...
export function UGFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-3r23fhnyu" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-rm2m1w6k1" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-6plb2wp8q" />
          </mask>
          <path id="mantine-6plb2wp8q" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-3r23fhnyu)">
          <use fill="#feca00" xlinkHref="#mantine-6plb2wp8q" />
          <path fill="#272727" d="M0 0h32v4H0z" mask="url(#mantine-rm2m1w6k1)" />
          <path fill="#d74800" d="M0 8h32v4H0z" mask="url(#mantine-rm2m1w6k1)" />
          <path fill="#272727" d="M0 12h32v4H0z" mask="url(#mantine-rm2m1w6k1)" />
          <path fill="#d74800" d="M0 20h32v4H0z" mask="url(#mantine-rm2m1w6k1)" />
          <circle cx="16" cy="12" r="6" fill="#f7fcff" mask="url(#mantine-rm2m1w6k1)" />
          <g mask="url(#mantine-rm2m1w6k1)">
            <path
              fill="#272727"
