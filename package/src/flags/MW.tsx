...
export function MWFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-f3cq20lhg" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-hojczpk4g" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-oe2br81az" />
          </mask>
          <path id="mantine-oe2br81az" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-f3cq20lhg)">
          <use fill="#e11c1b" xlinkHref="#mantine-oe2br81az" />
          <path fill="#272727" d="M0 0h32v10H0z" mask="url(#mantine-hojczpk4g)" />
          <path fill="#5eaa22" d="M0 16h32v8H0z" mask="url(#mantine-hojczpk4g)" />
          <g fill="#e11c1b" mask="url(#mantine-hojczpk4g)">
