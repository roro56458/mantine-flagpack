...
export function SZFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-klj6g7at9" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-gmv3pcqfg" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-a2qp8pbcz" />
          </mask>
          <path
            id="mantine-a2qp8pbcz"
        ...
        <g fill="none" fillRule="evenodd" mask="url(#mantine-klj6g7at9)">
          ...
          <g transform="translate(8.778 6)">
            <use fill="#f7fcff" xlinkHref="#mantine-a2qp8pbcz" />
            <path
              fill="#272727"
