...
export function BMFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
        ...
        <g fill="none" fillRule="evenodd" mask="url(#mantine-3znm2xj6i)">
          ...
          <g mask="url(#mantine-jjvuomadb)">
            ...
            <path
              fill="#000"
              fillRule="nonzero"
              d="M.24 8.652c0 .587.15.882.57 1.287.045.045.22.21.214.204a6.292 6.292 0 01.315.32c.335.372 1.4.793 3.159 1.227.462-.009 1.25-.274 2.345-.797 1.076-.514 1.691-1.144 1.866-1.885V.257H.24zM.03.042h8.889v8.99c-.184.826-.847 1.51-1.987 2.055-1.141.545-1.96.818-2.458.818-1.817-.447-2.913-.88-3.289-1.297C.622 9.98.03 9.748.03 8.652z"
              mask="url(#mantine-c81ikmwva)"
              transform="translate(21 11)"
            />
          </g>
          <g mask="url(#mantine-jjvuomadb)">
            <use fill="#2b409a" xlinkHref="#mantine-fdfky4qss" />
            <g mask="url(#mantine-v4xmfjupw)">
              <g fillRule="nonzero">
                <path
                  fill="#f7fcff"
