  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-wrb5zynf6" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-t8wcvcbb7" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-6un5uj6gr" />
          </mask>
          <path id="mantine-6un5uj6gr" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd">
          <g mask="url(#mantine-wrb5zynf6)">
            <use fill="#f7fcff" xlinkHref="#mantine-6un5uj6gr" />
            <path fill="#009d00" d="M0 0h32v8H0z" mask="url(#mantine-t8wcvcbb7)" />
            <path fill="#fff" d="M0 8h32v8H0z" mask="url(#mantine-t8wcvcbb7)" />
            <path fill="#f80000" d="M0 16h32v8H0z" mask="url(#mantine-t8wcvcbb7)" />
