...
export function MSFlag({ radius, className, size, ...others }: FlagProps) {
  return (
    <Box
        ...
        <g fill="none" fillRule="evenodd" mask="url(#mantine-sw3uc7ght)">
          ...
          <g mask="url(#mantine-r1odascxl)">
            ...
            <g mask="url(#mantine-ip0lj95zm)" transform="translate(20 10)">
              ...
              <path
                stroke="#ffc6b5"
                d="M6.746 3.464c-1.245.282-1.807.282-1.687 0 .12-.283.342-.933.664-1.95"
              />
              <path
                fill="#ffc6b5"
                d="M7.307 3.766a.655.655 0 01-.34-.59c0-.38-.831-.521-.245-1.115.585-.594.838-.333.838 0 0 .332.47 1.116.47 1.116l-.723.589z"
              />
              <path
                fill="#272727"
                d="M6.365.324v.908H8.22v.909H6.365v7.913h-.927V2.14H3.583v-.908h1.855V.324z"
              />
              <path
                fill="#0c7c38"
                d="M8.362 10.321c-.225-1.04-.337-1.918-.337-2.63 0-1.07-.566-1.834-.404-2.399.161-.565.55-1.19.356-1.577-.195-.387.19-.575-.356-.387s-.693-.188-1.22 0-.594 1.078-.594 1.331.235 1.965.235 2.498-.193 3.814.36 3.814c.552 0 1.154-.854 1.365-.854.14 0 .338.068.595.204z"
              />
              <path
                stroke="#ff9a06"
                d="M5.03 6.141c-.337 0-.027.783-.884 1.126-.857.343-1.026.826-.756.826.18 0 .982.8 2.405 2.398l.524-.809V7.127c-.635-.657-1.065-.986-1.29-.986z"
              />
              <path stroke="#979797" d="M7.543 10.158c.267.572.267.858 0 .858" />
              <path
                stroke="#ffc6b5"
                d="M7.414 3.79c-.117.642-.287 1.03-.51 1.165-.334.201-1.709.591-1.709.925 0 .222-.045.373-.136.452"
              />
              <path
                fill="#ff9a06"
                d="M6.748 1.803c.224.266.399.619.525 1.058.188.659.733.883.733.575 0-.308.404-1.633 0-1.633H6.748z"
              />
            </g>
          </g>
          <g mask="url(#mantine-r1odascxl)">
